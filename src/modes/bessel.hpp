...
// 		/*
// 		Much of the code below is shared with the bessel() function declared
// 		above, as I could not figure out how to pass arrays between functions.
// 		*/
// 		// calculate J_k(x) for all k < n
// 		int maxmx = fmax(n, (int)z_nm);
...
// 		}
// 		/*
// 		Much of the code above is shared with the bessel() function declared
// 		above, as I could not figure out how to pass arrays between functions.
// 		*/
